    ...
    <Box bg={mode('blue.200', 'blue.900')} px={4}>
      <Flex h={'16'} alignItems={'center'} justifyContent={'space-between'}>
        <IconButton
          ...
          display={{ md: 'none' }}
          onClick={isOpen ? onClose : onOpen}></IconButton>
        ...
        <HStack>
          <ButtonGroup spacing={'0'} variant={'ghost'} display={{ base: 'none', md: 'flex' }}>
            <IconButton as={'a'} href='a' icon={<FaFacebook fontSize={'1.25rem'} />} />
            <IconButton as={'a'} href='a' icon={<FaTwitter fontSize={'1.25rem'} />} />
            <IconButton as={'a'} href='a' icon={<FaYoutube fontSize={'1.25rem'} />} />
            <IconButton as={'a'} href='a' icon={<FaInstagram fontSize={'1.25rem'} />} />
          </ButtonGroup>
